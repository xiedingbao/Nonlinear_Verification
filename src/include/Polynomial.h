...
public:
	...
	Polynomial(const Number & constant, const int numVars);			// constant polynomial where dim is the number of the variables
	...
	Number constant() ;											// constant part of the polynomial
...
//	void sub_assign(const Monomial & monomial);										// subtract a monomial
	...
	void mul_assign(const Number & I);											// multiplied by an interval
